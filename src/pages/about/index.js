    ...
    <Wrapper>
      <Content width="50%">
        ...
        <TextBlock theme={theme}>
          ...
          aplicações web e mobile usando JavaScript.
          <br />
          <br />
          Também tenho experiência na utilização tanto do paradigma de
          orientação a objetos tanto quanto funcional, atuo também na modelagem
          de databases relacionais e não relacionais além de projetos de
      ...
      <Content width="50%">
        ...
        <TextBlock theme={theme}>SKILLS BAR</TextBlock>
      </Content>
    </Wrapper>
  </Page>
)
